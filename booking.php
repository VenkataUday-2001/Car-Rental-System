   ...
   <?php
    ...
    <div class="container">
        <div class="py-5 text-center">
          ...
          <h2>Booking Form</h2>
          <p class="lead">Please Ensure You are entering the correct details And Please check prise While Checkout If you are comfortable<br> We Ensure You Book a Comfortable Car...&...Have a Safe Drive</p>
        </div>
        ...
        <footer class="my-5 pt-5 text-muted text-center text-small">
          <p class="mb-1">&copy; Copyright 2021 - Group 19</p>
