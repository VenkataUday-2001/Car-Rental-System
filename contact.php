                ...
                <div class="row">
                    ...
                    <form action="" method="POST" class="col-lg-6">
                        <div class="form-group">
                            <label for="email" style="color: blanchedalmond;" require="required">Email</label>
                        ...
                        <div class="form-group">
                            <label for="name" style="color: blanchedalmond;"require="required" >Name</label>
                            <input id="name" class="form-control" type="text" placeholder="Your Name" style="background-color: #8a8a8a;" name="f_name">
                        </div>
                        <div class="form-group">
                            <label for="message" style="color: blanchedalmond;" require="required">Message</label><br>
